      ...
      <div className={style.learnRow}>
        <div className={style.leftHandSide}>
          <div className={style.learnText}>
            ...
            in a simpler, more engaging, and enjoyable way!
          </div>

          <div className={style.btnContainer}>
            <button
              onClick={() => router.push(Route.MainApp)}
              className={style.getStartedBtn}
            >
              Get Started
            </button>
            <button className={style.alreadyBtn}>
      ...
      <div className={style.footerContainer}>
        ...
        <div className={style.linkContainer}>
          {links.map((link, index) => (
            <Link key={index} className={style.linkText} href={link.href}>
              {link.text}
            </Link>
          ))}
        </div>
